...
class DataProcessConfig(BaseModel):
    output_dir: str = "data/multi-20x20_more_length"
...
def convert_subset(set_name: str, config: DataProcessConfig):
    ...
    with open(f"multi_data/{height}×{width}_more_length/{set_name}.csv", newline="") as csvfile:
